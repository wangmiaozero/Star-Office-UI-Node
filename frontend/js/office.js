        ...
        function getAreaRect(area) {
            // 区域坐标（wangmiaozero提供，左上-右下；这里的 x/y 作为 sprite 底部锚点坐标来用）
        ...
        function preload() {
            ...
            this.load.image('office_bg', '/static/office_bg_small' + (supportsWebP ? '.webp' : '.png') + '?v=' + (window.__VERSION_TS__ || '') + '');
            ...
            this.load.image('guestagent1', '/static/guestagent1.webp?v=' + (window.__VERSION_TS__ || '') + '');
            this.load.image('guestagent2', '/static/guestagent2.webp?v=' + (window.__VERSION_TS__ || '') + '');
            this.load.spritesheet('guest_anim_1', '/static/guest_anim_1.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.spritesheet('guest_anim_2', '/static/guest_anim_2.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.spritesheet('guest_anim_3', '/static/guest_anim_3.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.spritesheet('guest_anim_4', '/static/guest_anim_4.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.spritesheet('guest_anim_5', '/static/guest_anim_5.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.spritesheet('guest_anim_6', '/static/guest_anim_6.webp?v=' + (window.__VERSION_TS__ || '') + '', { frameWidth: 32, frameHeight: 32 });
            this.load.image('demo_nika', '/static/demo_nika.webp?v=' + (window.__VERSION_TS__ || '') + '');
            this.load.image('demo_mercury', '/static/demo_mercury.webp?v=' + (window.__VERSION_TS__ || '') + '');
        }
